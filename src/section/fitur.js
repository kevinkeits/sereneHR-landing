...
const Fitur = () => {
  return (
    <div id="fitur-div" class="">
        ...
        <h1 class="bg-blue-600 flex items-center justify-center text-3xl text-white font-bold py-8">Fitur</h1>
        <div class="bg-blue-600 p-2 md:flex md:items-center md:gap-2 mx-auto md:px-20 px-2 justify-center py-8">
            <div class="max-w-lg mx-auto md:mx-1">
                <h1 class="text-3xl text-white font-semibold px-5">Manajemen Data Karyawan</h1>
            ...
            <div class="md:max-w-lg max-w-md px-3 py-3 mx-auto md:mx-1">
        ...
        <div class="bg-white p-2 md:flex md:items-center gap-2 md:px-20 px-2 md:justify-center py-8">
            ...
            <div class="max-w-lg mx-auto md:mx-1">
                <h1 class="text-3xl font-semibold my-5 px-5">Penggajian <b>Otomatis</b></h1>
        ...
        <div class="bg-blue-600 p-2 md:flex md:gap-2 md:items-center md:justify-center md:px-20 px-2 py-16">
            <div class="max-w-lg mx-auto md:mx-1">
                <h1 class="text-3xl text-white font-semibold my-5 px-5">Pengelolaan <b>Absensi</b> dan <b>Cuti</b></h1>
        ...
        <div class="bg-white p-2 md:flex md:items-center md:justify-center md:px-20 px-2 gap-2 py-16">
            <div class="md:max-w-lg max-w-md px-3 mx-auto md:mx-1">
