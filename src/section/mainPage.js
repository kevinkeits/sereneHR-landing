    ...
    <div id="mainpage-div" className="relative w-full h-screen">
      ...
      <div className="absolute top-0 left-0 w-full h-full flex flex-col justify-center items-center">
        <div className="container mx-auto text-center text-white">
          <h1 className="animated-link lg:text-5xl text-4xl font-bold mb-4">SereneHR - Solusi HR Terpadu Anda</h1>
          <h2 className="animated-link lg:text-2xl font-semibold mb-8">Meringankan Proses HR Anda dengan Mudah</h2>
